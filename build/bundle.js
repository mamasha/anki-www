...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$7, 18, 4, 531);
    			attr_dev(button1, "class", /*_bgColor*/ ctx[4]);
    			add_location(button1, file$7, 24, 4, 624);
    			set_style(div, "grid-area", /*ga*/ ctx[0]);
    			set_style(div, "font-size", /*sz*/ ctx[1]);
    			add_location(div, file$7, 17, 0, 482);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Pair extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*ga*/ ctx[0] === undefined && !("ga" in props)) {
    			console_1.warn("<Pair> was created without expected prop 'ga'");
    		}
    	}
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*_digit*/ ctx[2]);
    			attr_dev(button, "class", /*_bgColor*/ ctx[3]);
    			add_location(button, file$6, 16, 4, 447);
    			set_style(div, "grid-area", /*ga*/ ctx[0]);
    			set_style(div, "font-size", /*sz*/ ctx[1]);
    			add_location(div, file$6, 15, 0, 398);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
