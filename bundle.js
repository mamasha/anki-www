...
var app = (function () {
    ...
    function buildMp3Library(assetsFolder) {
    	run(() => loadFrom(""));
    	run(() => loadFrom(assetsFolder));
    }

    function soundSwitch(soundOn) {
    	_soundOn = soundOn;
    }
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(button, "grid-area", /*ga*/ ctx[0]);
    			set_style(button, "font-size", /*sz*/ ctx[2]);
    			add_location(button, file$6, 18, 0, 461);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let _settings = Settings;
    	buildMp3Library(_settings.assetsFolder);
    	soundSwitch(_settings.soundOn);
    	const writable_props = [];
